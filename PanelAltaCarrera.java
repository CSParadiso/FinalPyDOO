...
public class PanelAltaCarrera extends JPanel {
  static JTextField campoNombre, campoNombreMateriaNueva, campoInfoNombre, campoInfoCarrera, campoInfoPromocionable,
      campoInfoOpcional,
      campoInfoCuatrimestre, campoInfoNotaPromocionar, campoInfoNotaAprobarCursada, campoInfoNotaAprobarFinal,
      campoInfoCorrelativas, campoInfoPlan;
  JButton botonCrearCarrera, botonCrearMateria, botonAgregarCorrelativas, botonRemoverCorrelativas;
  JPanel panelNombre, panelPlanes, panelOpcionalesMinimas, panelBoxSuperior, panelInferiorIzquierdo,
      panelInferiorDerecho,
      panelBoxInferior, panelCarreras, panelMaterias, panelCuatrimestreMateria, panelNotasMateria,
      panelBotonesCorrelativas,
  ...
  ControladorMultiPestania controlador; // Singleton, redirecciona a los tres distintos Controladores (uno por cada
                                        // JTabbed Pane)
  ...
  PanelAltaCarrera() {
    ...
    panelCorrelativas
        .setBorder(BorderFactory.createTitledBorder("Agregar Correlativas (CTRL + click para deseleccionar)"));
    ...
    campoInfoPlan = new JTextField("CARACTERniSTICAS DEL PLAN DE ESTUDIO", 46);
    ...
    campoEspacio.setBackground(this.getBackground()); // Acni irnia un arbol que va mostrando las carreras, sus materias
                                                      // y correlativas
  ...
  private String determinarJRadioButtonPresionado() {
    // Esto hay que hacerlo menos rnistico
  ...
  // Mnitodos que invocan los listeners y luego se redirigen al controlador
  ...
  private void botonCrearCarreraPresionado() {
    ...
    if (nombre.length() != 0)
      ...
      campoNombre.setText("niDebe ingresar un nombre para crear una carrera!");
  };
  ...
  private void botonCrearMateriaPresionado() {
    ...
    if (nombre.length() != 0 && carrera != "Seleccione una carrera" &&
        ...
        !nombre.equals("niDebe ingresar un nombre para crear una carrera!") &&
        !nombre.equals("Nombre de la materia") &&
        !nombre.equals("niSeleccionar Carrera y nombre de Materia!") &&
        !nombre.equals("niNo se pueden definir mnis materias opcionales!"))
      ...
      campoNombreMateriaNueva.setText("niSeleccionar Carrera y nombre de Materia!");
  };
