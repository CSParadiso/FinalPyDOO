...
public class PanelDesempenioEstudiante extends JPanel {
  ...
  PanelDesempenioEstudiante() {
    ...
    // panelBoxDerecho.add(new JTextField("Materias que pueden ser seteadas las
    // notas"));
    ...
    // Inicializacinin del Controlador de esta Vista
