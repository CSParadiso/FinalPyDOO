...
public class Materia {
  ...
  private int notaParaAprobarFinal; // Sernia la nota del final
  ...
  Materia(Carrera carrerita, String name, int cuatri, int notaAprobacionCursada, int notaAprobacionFinal,
      boolean optional) {
    setCodigo();
    setCarrera(carrerita);
    setNombre(name);
  ...
  void aniadirCorrelativa(Materia correlativa) {
