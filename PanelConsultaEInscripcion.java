...
public class PanelConsultaEInscripcion extends JPanel {
  ...
  PanelConsultaEInscripcion() {
    ...
    panelInfoEstudiante.setBorder(BorderFactory.createTitledBorder("Informacinin Estudiante"));
    ...
    // Inicializacinin Controldor de esta Vista
    controlador = ControladorMultiPestania.getInstancia(this);

    // Listeners que disparan el Controlador de esta Vista
    tablaEstudiantes.getSelectionModel().addListSelectionListener(new ListSelectionListener() { // NO es la tabla sinni
                                                                                                // su modo de seleccinin
